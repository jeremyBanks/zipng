//! `u8` to `u8` mappings that can be used to transform
//! [`EightBit`][crate::EightBit] palettes.

/// Returns a new palette that is the result of applying the given `mapping`
/// to the provided [`EightBit`] palette.
...
/// bit.
pub static SHUFFLED_IN_2: [u8; 256] = [0; 256];

/// A `u8` to `u8` mapping with values sorted by number of bits set.
pub static BIT_COUNT: [u8; 256] = [
