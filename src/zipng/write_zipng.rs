use {
    crate::{
        ...
        write_zlib, Align, BitDepth, ColorType, InputWrite, Offset, OutputBuffer, Zip,
        PNG_CHUNK_PREFIX_SIZE, PNG_CHUNK_SUFFIX_SIZE, PNG_CHUNK_WRAPPER_SIZE, PNG_HEADER_SIZE,
        ZIP_FILE_HEADER_EMPTY_SIZE,
    },
    bstr::ByteSlice,
