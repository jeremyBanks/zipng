...
impl<'a, W: Write + 'a> ser::Serializer for Serializer<'a, W> {
    ...
    fn serialize_u64(self, v: u64) -> Result<()> {
        wire::write_varint(self.writer, WireType::VarInt, v)
    }
    ...
    fn serialize_u128(self, v: u128) -> Result<()> {
        wire::write_varint_128(self.writer, WireType::VarInt, v)
    }
    ...
    fn serialize_bytes(self, v: &[u8]) -> Result<()> {
        wire::write_varint(self.writer, WireType::VarLength, v.len() as u64)?;
    ...
    fn serialize_unit_variant(
        ...
        wire::write_varint(self.writer, WireType::VarInt, variant_index as u64)?;
        self.serialize_unit()
    }
    ...
    fn serialize_seq(self, len: Option<usize>) -> Result<Self::SerializeSeq> {
        // we have a single wire type left -- could use it; but I don't think this case
        // is very common?
    ...
    fn serialize_tuple(self, len: usize) -> Result<Self::SerializeTuple> {
        wire::write_varint(self.writer, WireType::VarLength, len as u64)?;
        Ok(self)
    }
