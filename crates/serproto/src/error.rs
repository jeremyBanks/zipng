...
pub enum Error {
    ...
    InvalidUtf8,
    /// The input was longer than expected. If it was expected, please use
    /// [`from_bytes_more_data`](fn@crate::from_bytes_more_data).
    ...
    UnexpectedWireType,
    /// A sequence with an odd number of elements was read, which is invalid for
    /// a map.
