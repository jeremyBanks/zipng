...
impl<'de> Deserializer<'de> {
    ...
    #[inline]
    fn read_varint(&mut self, tag_byte: u8) -> Result<u64> {
        let (value, len) = wire::read_varint(tag_byte, self.input)?;
        self.consume(len);
        Ok(value)
    }

    #[inline]
    fn read_varint_128(&mut self, tag_byte: u8) -> Result<u128> {
        let (value, len) = wire::read_varint_128(tag_byte, self.input)?;
        self.consume(len);
        Ok(value)
    }
    ...
    fn skip(&mut self) -> Result<()> {
        ...
        match wire::read_wire_type(tag_byte) {
            WireType::VarInt => {
                let len = wire::skip_varint(tag_byte, self.input)?;
                self.consume(len);
            }
            WireType::Fixed32 => {
                self.read_32()?;
            ...
            WireType::VarLength => {
                let len = self.read_varint(tag_byte)?;
                for _ in 0..len {
                    self.skip()?;
                }
            }
...
impl<'de, 'a> de::Deserializer<'de> for &'a mut Deserializer<'de> {
    ...
    fn deserialize_i8<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        let tag_byte = self.read_byte()?;
        if wire::read_wire_type(tag_byte) != WireType::VarInt {
            return Err(Error::UnexpectedWireType);
        }
        let v: i8 = wire::zigzag_decode(self.read_varint(tag_byte)?).try_into()?;
        visitor.visit_i8(v)
    }
    ...
    fn deserialize_i16<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        ...
        let v: i16 = wire::zigzag_decode(self.read_varint(tag_byte)?).try_into()?;
        visitor.visit_i16(v)
    }
    ...
    fn deserialize_i32<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        ...
        let tag_byte = self.read_byte()?;
        let v: i32 = match wire::read_wire_type(tag_byte) {
            WireType::VarInt => wire::zigzag_decode(self.read_varint(tag_byte)?).try_into()?,
    ...
    fn deserialize_i64<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        let tag_byte = self.read_byte()?;
        let v: i64 = match wire::read_wire_type(tag_byte) {
            WireType::VarInt => wire::zigzag_decode(self.read_varint(tag_byte)?),
    ...
    fn deserialize_u8<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        ...
        let v: u8 = self.read_varint(tag_byte)?.try_into()?;
        visitor.visit_u8(v)
    }
    ...
    fn deserialize_u16<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        ...
        let v: u16 = self.read_varint(tag_byte)?.try_into()?;
        visitor.visit_u16(v)
    }
    ...
    fn deserialize_u32<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        let tag_byte = self.read_byte()?;
        let v: u32 = match wire::read_wire_type(tag_byte) {
            WireType::VarInt => self.read_varint(tag_byte)?.try_into()?,
    ...
    fn deserialize_u64<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        let tag_byte = self.read_byte()?;
        let v: u64 = match wire::read_wire_type(tag_byte) {
            WireType::VarInt => self.read_varint(tag_byte)?,
    ...
    fn deserialize_f32<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        let tag_byte = self.read_byte()?;
        let v = match wire::read_wire_type(tag_byte) {
    ...
    serde::serde_if_integer128! {
        ...
        fn deserialize_i128<V:Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
            ...
            let v  = wire::zigzag_decode_128(self.read_varint_128(tag_byte)?);
        ...
        fn deserialize_u128<V:Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
            ...
            let v  = self.read_varint_128(tag_byte)?;
    ...
    fn deserialize_bytes<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        let tag_byte = self.read_byte()?;
        if wire::read_wire_type(tag_byte) != WireType::VarLength {
            return Err(Error::UnexpectedWireType);
        }
        let len = self.read_varint(tag_byte)?;
    ...
    fn deserialize_option<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        ...
        let b = self.read_varint(tag_byte)?;
        if b == 0 {
            self.skip()?;
            visitor.visit_none()
        } else {
    ...
    fn deserialize_seq<V: Visitor<'de>>(self, visitor: V) -> Result<V::Value> {
        ...
        let n = self.read_varint(tag_byte)? as usize;
...
impl<'de, 'a> EnumAccess<'de> for &'a mut Deserializer<'de> {
    ...
    fn variant_seed<V: de::DeserializeSeed<'de>>(
        ...
        let discr: u32 = self.read_varint(tag_byte)?.try_into()?;
...
// this is for the case when an overly long struct or tuple is received, or not
// the entire sequence is read for another reason, or the variant is not
// accessed (in #[serde(other)])
